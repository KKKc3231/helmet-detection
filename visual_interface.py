...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, weight_path, out_file_path, real_time_show_predict_flag: bool, parent=None):
        ...
        self.setupUi(self)
        # self.setWindowTitle("YoloV5 安全帽检测 " + CODE_VER)
        self.setWindowTitle("YoloV5安全帽检测系统")
        self.showMaximized()
        '''按键绑定'''
        # 输入媒体
        ...
        self.weight_label.setText(f" 模型 : ****** {Path(weight_path[0]).name} ******")
        # 界面美化
        self.gen_better_gui()
    ...
    def gen_better_gui(self):
        ...
        # 设置显示图片的 label 为蓝色北京
        self.input_real_time_label.setStyleSheet("QLabel{background:blue}")
        self.output_real_time_label.setStyleSheet("QLabel{background:blue}")
...
if __name__ == '__main__':
    ...
    # 设置窗口图标
    icon = QIcon()
    icon.addPixmap(QPixmap("./UI/icon/hat.png"), QIcon.Normal, QIcon.Off)
